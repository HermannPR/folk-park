...
inline constexpr std::array lfoTempoSync{
    "lfo1TempoSync", "lfo2TempoSync", "lfo3TempoSync", "lfo4TempoSync"};
inline constexpr std::array lfoRetrigger{
    "lfo1Retrigger", "lfo2Retrigger", "lfo3Retrigger", "lfo4Retrigger"};
...
inline constexpr std::array<const char*, 73> synthAndModulation{
    masterGain, oscillatorWaveform, oscillatorLevel, oscillatorAPosition,
    oscillatorACoarse, oscillatorAFine, oscillatorAPhase, oscillatorARandomPhase,
    oscillatorAPan, oscillatorAUnison, oscillatorADetune, oscillatorASpread,
    oscillatorABlend, oscillatorAPhaseReset, oscillatorBPosition, oscillatorBCoarse,
    oscillatorBFine, oscillatorBPhase, oscillatorBRandomPhase, oscillatorBLevel,
    oscillatorBPan, oscillatorBUnison, oscillatorBDetune, oscillatorBSpread,
    oscillatorBBlend, oscillatorBPhaseReset, subWaveform, subOctave, subLevel,
    noiseType, noiseLevel, filterMode, filterCutoff, filterResonance, filterDrive,
    filterKeyTracking, filterEnvelopeAmount, ampAttack, ampDecay, ampSustain,
    ampRelease, filterEnvelopeAttack, filterEnvelopeDecay, filterEnvelopeSustain,
    filterEnvelopeRelease, auxiliaryEnvelopeAttack, auxiliaryEnvelopeDecay,
    auxiliaryEnvelopeSustain, auxiliaryEnvelopeRelease,
    lfoShape[0], lfoShape[1], lfoShape[2], lfoShape[3],
    lfoRate[0], lfoRate[1], lfoRate[2], lfoRate[3],
    lfoSyncDivision[0], lfoSyncDivision[1], lfoSyncDivision[2], lfoSyncDivision[3],
    lfoPhase[0], lfoPhase[1], lfoPhase[2], lfoPhase[3],
    lfoTempoSync[0], lfoTempoSync[1], lfoTempoSync[2], lfoTempoSync[3],
    lfoRetrigger[0], lfoRetrigger[1], lfoRetrigger[2], lfoRetrigger[3]
};

inline constexpr std::array distortion{
    distortionBypass, distortionDrive, distortionMix, distortionOutput};
inline constexpr std::array chorus{chorusBypass, chorusRate, chorusDepth, chorusMix};
inline constexpr std::array delay{delayBypass, delayDivision, delayFeedback, delayMix};
inline constexpr std::array reverb{reverbBypass, reverbRoomSize, reverbDamping, reverbMix};
inline constexpr std::array compressor{
    compressorBypass, compressorThreshold, compressorRatio, compressorAttack,
    compressorRelease, compressorMakeup, compressorMix};
inline constexpr std::array equalizer{
    eqBypass, eqLowGain, eqMidFrequency, eqMidGain, eqMidQ, eqHighGain};
inline constexpr std::array effectOrder{
    "distortion", "chorus", "delay", "reverb", "compressor", "eq"};

inline constexpr std::array<const char*, 29> allEffects{
    distortionBypass, distortionDrive, distortionMix, distortionOutput,
    chorusBypass, chorusRate, chorusDepth, chorusMix,
    delayBypass, delayDivision, delayFeedback, delayMix,
    reverbBypass, reverbRoomSize, reverbDamping, reverbMix,
    compressorBypass, compressorThreshold, compressorRatio, compressorAttack,
    compressorRelease, compressorMakeup, compressorMix,
    eqBypass, eqLowGain, eqMidFrequency, eqMidGain, eqMidQ, eqHighGain
};
