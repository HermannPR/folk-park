...
The active hardening priority is [M9 Audio Stability](plans/M9_AUDIO_STABILITY.md), created after the producer reported intermittent crackling and complete distortion during composition audition. M9 now measures cumulative pre-master/output peak, over-unity samples, maximum active voices, and voice steals through bounded atomic telemetry. A normal generated four-part fixture stays below unity but reaches all 16 voices and steals 13; a deliberate supported extreme-gain fixture reaches `16.8816`, proving that output-ceiling work is required. The exact audible defect is not yet claimed resolved: deadline, effects, gain, and delivery cases remain separated until measurement identifies the cause.
