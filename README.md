...
The active hardening priority is [M9 Audio Stability](plans/M9_AUDIO_STABILITY.md), created after the producer reported intermittent crackling and complete distortion during composition audition. M9 measures and separates output overload, DSP instability, voice pressure, MIDI delivery faults, and host deadline misses before changing gain staging or performance. It is a plan in progress, not a claim that the audible defect is already resolved.
